#include "main.h"
/**
 * handle_print - Prints an arg based on the type of it
 * @fmt: The formatted string to print the arg
 * @list: Args list tobe printed
 * @ind: ind
		...
		char buffer[], int flags, int width, int precision, int size)
{
	...
	for (i = 0; fmt_types[i].fmt != '\0'; i++)
		if (fmt_types[*ind] == fmt_types[i].fmt)
